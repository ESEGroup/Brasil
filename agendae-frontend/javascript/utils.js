/**
 * Fuzzy match search function
 * REF: https://github.com/forrestthewoods/lib_fts/blob/master/code/fts_fuzzy_match.js
 * VERSION 0.1.0
 */
...
function Fts_fuzzy_match_async(matchFn, pattern, dataSet, onComplete) {
    ...
    function step() {
        ...
        for (; dataIndex < dataSet.length; ++dataIndex) {
            ...
            var result = matchFn(pattern, str.name);
...
// Enables Array.prototype.indexOf in older browsers
